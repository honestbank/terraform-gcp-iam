	...
	test_structure.RunTestStage(t, testCaseName+"_create_test_copy", func() {
		...
		terraformOptions = terraform.WithDefaultRetryableErrors(t, &terraform.Options{
			...
			Vars: map[string]interface{}{
				...
				"cross_project_condition_title":       "terratest-" + run,
				"cross_project_condition_description": "created by terratest run: " + run,
				"cross_project_condition_expression":  "google_service_account.account.project_id != \"\"",
			},
		})
	})
