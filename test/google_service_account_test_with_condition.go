	...
	test_structure.RunTestStage(t, "create_test_copy", func() {
		...
		terraformOptions = terraform.WithDefaultRetryableErrors(t, &terraform.Options{
			...
			Vars: map[string]interface{}{
				...
				"in_project_condition_title":       "terratest-condition-" + run,
				"in_project_condition_description": "created by terratest run: " + run,
				"in_project_condition_expression":  "google_service_account.account.project_number == 100",
			},
		})
	})
